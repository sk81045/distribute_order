...
type Record struct {
	...
	Stime string `form:"stime" json:"stime"  binding:"required,min=0"`
	Etime string `form:"etime" json:"etime"  binding:"required,min=0"`
	Sign  string `form:"sign" json:"sign"  binding:"required,min=0"`
}

func (n Record) CheckParams(context *gin.Context) {
...
// 	(&dealings.Smv1{}).UserInfo(context)
